...
get_administrative_division_tool = StructuredTool.from_function(
    ...
    description=(
        ...
        "The API key is read from the environment variable 'amap_api_key'. "
        ...
        "With the generated shapefile, this tool enables further analysis, such as regional statistics for night-time light imagery, "
        "which is useful in various spatial analyses.\n\n"
        "### Example Usage:\n"
        "- city: '北京'\n"
        "- save_path: 'C:/NTL_Agent/report/shp/shape_files'\n\n"
        "### Returns:\n"
        "Message indicating the success or failure of the Shapefile generation and its save location, supporting further regional "
        "night-time light analysis and other geospatial analyses for the specified administrative division."
    ),
