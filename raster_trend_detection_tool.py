...
def raster_trend_detection(raster_files: List[str], save_path: Optional[str] = None) -> str:
    """
...
raster_trend_detection_tool = StructuredTool.from_function(
    raster_trend_detection,
